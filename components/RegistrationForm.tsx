...
const RegistrationForm: React.FC<RegistrationFormProps> = ({ onLogin }) => {
  ...
  return (
    <div className="w-full max-w-md p-8 space-y-6 bg-black/30 backdrop-blur-xl rounded-xl shadow-2xl border border-cyan-400/30 shadow-cyan-500/20">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2 mt-2 text-white bg-black/40 border border-slate-600 rounded-lg focus:border-cyan-400 focus:ring-2 focus:ring-cyan-500/50 transition-all"
        ...
        <button
          type="submit"
          className="w-full py-3 font-semibold text-white bg-gradient-to-r from-cyan-500 to-blue-600 rounded-lg hover:shadow-lg hover:shadow-cyan-500/40 transition-all duration-300 transform hover:-translate-y-px"
        >
          Entrar
        </button>
      </form>
